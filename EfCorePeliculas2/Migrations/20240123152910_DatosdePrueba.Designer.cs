...
namespace EfCorePeliculas2.Migrations
{
    ...
    [Migration("20240123152910_DatosdePrueba")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EfCorePeliculas2.Entidades.Actor", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EfCorePeliculas2.Entidades.Cine", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EfCorePeliculas2.Entidades.CineOferta", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasData(
                        new
                        {
                            Id = 2,
                            CineId = 4,
                            FechaFin = new DateTime(2024, 1, 28, 0, 0, 0, 0, DateTimeKind.Local),
                            FechaInicio = new DateTime(2024, 1, 23, 0, 0, 0, 0, DateTimeKind.Local),
                        ...
                        new
                        {
                            Id = 1,
                            CineId = 1,
                            FechaFin = new DateTime(2024, 1, 30, 0, 0, 0, 0, DateTimeKind.Local),
                            FechaInicio = new DateTime(2024, 1, 23, 0, 0, 0, 0, DateTimeKind.Local),
                            PorcentajeDescuento = 10m
                        });
                });

            modelBuilder.Entity("EfCorePeliculas2.Entidades.Genero", b =>
                {
            ...
            modelBuilder.Entity("EfCorePeliculas2.Entidades.Pelicula", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EfCorePeliculas2.Entidades.PeliculaActor", b =>
                {
            ...
            modelBuilder.Entity("EfCorePeliculas2.Entidades.SalaDeCine", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EfCorePeliculas2.Entidades.CineOferta", b =>
                {
                    b.HasOne("EfCorePeliculas2.Entidades.Cine", null)
                        .WithOne("CineOferta")
                        .HasForeignKey("EfCorePeliculas2.Entidades.CineOferta", "CineId")
            ...
            modelBuilder.Entity("EfCorePeliculas2.Entidades.PeliculaActor", b =>
                {
                    b.HasOne("EfCorePeliculas2.Entidades.Actor", "Actor")
                        .WithMany("PeliculasActores")
                        .HasForeignKey("ActorId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("EfCorePeliculas2.Entidades.Pelicula", "Pelicula")
                        .WithMany("PeliculasActores")
            ...
            modelBuilder.Entity("EfCorePeliculas2.Entidades.SalaDeCine", b =>
                {
                    b.HasOne("EfCorePeliculas2.Entidades.Cine", "Cine")
                        .WithMany("SalaDeCine")
            ...
            modelBuilder.Entity("GeneroPelicula", b =>
                {
                    b.HasOne("EfCorePeliculas2.Entidades.Genero", null)
                        .WithMany()
                        .HasForeignKey("GenerosIdentificador")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("EfCorePeliculas2.Entidades.Pelicula", null)
                        .WithMany()
            ...
            modelBuilder.Entity("PeliculaSalaDeCine", b =>
                {
                    ...
                    b.HasOne("EfCorePeliculas2.Entidades.SalaDeCine", null)
                        .WithMany()
